...
public class OutboundNetworkConfig extends ConfigPopupWindow{
	
	private SearchPopupList 	popupList 					= null;
	
	public OutboundNetworkConfig(Shell parent) {
		super(parent);
	}

	public HashMap<String, Object> open(IWorkbenchWindow window, Image icon) {
		super.open(window, icon, "Outbound Network", new Point(400, 400));
