...
import com.nabsys.nabeeplus.views.model.NBPopEditingSupport;
...
public class ExceptionConfig  extends ConfigPopupWindow{
	...
	public HashMap<String, Object> open(IWorkbenchWindow window, Image icon) {
		...
		column.getColumn().setMoveable(false);
		column.getColumn().setAlignment(SWT.LEFT);
		column.setEditingSupport(valueEditingSupport = new NBPopEditingSupport(column.getViewer(), 
		...
		valueEditingSupport.addNBCellClickListener(new NBCellClickListener(){
			public ArrayList<String> cellClick(Object element) {
				ArrayList<String> list = new ArrayList<String>();
				list.add("Exception Type");
				list.add("Exception Message");
				list.add("Stack Trace");
				list.add(NBLabel.get(0x023A));
				return list;
			}
		});
