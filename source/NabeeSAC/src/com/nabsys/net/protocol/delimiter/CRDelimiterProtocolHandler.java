...
public class CRDelimiterProtocolHandler extends DelimiterFrameDecoder{
	
	private TelegramFieldContext[] telegramFieldArray;
	private NetworkContext networkContext;
	
	public CRDelimiterProtocolHandler(NetworkContext networkContext, TelegramFieldContextList telegramFieldArrayContextList)
	{
		super(Delimiter.CARRIAGE_RETURN.getDelimiter(), 2000);
	...
	protected Object encode(NBFields fields) throws UnsupportedEncodingException, ProtocolException
	{
		...
		buffer.put(Delimiter.CARRIAGE_RETURN.getDelimiter());
		buffer.rewind();
		return buffer;
	}
