...
public class NullDelimiterProtocolHandler extends DelimiterFrameDecoder{
	
	private TelegramFieldContext[] telegramFieldArray;
	private NetworkContext networkContext;
	
	public NullDelimiterProtocolHandler(NetworkContext networkContext, TelegramFieldContextList telegramFieldArrayContextList)
	{
		super(Delimiter.NULL.getDelimiter(), 2000);
	...
	protected Object encode(NBFields fields) throws UnsupportedEncodingException, ProtocolException
	{
		...
		buffer.put(Delimiter.NULL.getDelimiter());
		buffer.rewind();
		return buffer;
	}
