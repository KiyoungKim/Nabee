...
public class ResultSet implements java.sql.ResultSet{
	...
	public ResultSet(PreparedStatement pstmt) throws SQLException
	{
		this.pstmt = pstmt;
	...
	protected ResultSet(Statement st, String sql) throws SQLException
	{
		this.st = st;
	...
	{
		return md.getColumnLabel(index);
	}
